package com.ferragem.avila.pdv.dto.produto;
...
public record ProdutoDto(
        ...
        @NotNull @PositiveOrZero Float estoque, @Positive @Max(value = 999999) BigDecimal precoFornecedor,
        @NotNull @Positive @Max(value = 999999) BigDecimal preco,
		@Nullable boolean gerarCodigoBarrasEAN13,
        @Nullable @Size(min = 13, max = 13, message = "Campo código de barras deve ter 13 caracteres, conforme padrão EAN 13.") String codigoBarrasEAN13,
